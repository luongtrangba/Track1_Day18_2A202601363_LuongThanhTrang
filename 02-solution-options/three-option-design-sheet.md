...
| **Ràng buộc tốc độ phản hồi (theo H2')** | Không áp dụng — checkpoint tĩnh, không cạnh tranh tốc độ với công cụ ngoài. | Quiz cần chấm và phản hồi **ngay lập tức** (< vài giây); nếu chậm, học viên bỏ quiz giữa chừng để hỏi AI ngoài như đã làm với AI tutor VLearn cũ. | **Bắt buộc phản hồi chat trong vài giây.** H2' cho thấy học viên đã từng dùng AI tutor VLearn rồi bỏ vì *"mất cỡ 1-2 phút/câu"* nên chuyển hẳn sang AI ngoài — nếu Option C lặp lại độ trễ này, tín hiệu sẽ tiếp tục chảy ra ngoài hệ thống y như cũ, thiết kế thất bại ngay từ gốc. |
...
**Lưu ý theo H2' (tín hiệu chảy ra ngoài hệ thống):** Evidence cho thấy học viên (U4) từng dùng AI tutor của VLearn rồi **bỏ hẳn** vì phản hồi chậm (1–2 phút/câu), chuyển toàn bộ câu hỏi lẫn ghi chú sang công cụ ngoài — nơi hệ thống không nhìn thấy. Option C chỉ giữ được tín hiệu trong hệ thống nếu tốc độ phản hồi chat **nhanh hơn hẳn** trải nghiệm cũ đã khiến học viên rời bỏ; nếu không, Option C tái lặp đúng nguyên nhân gốc của H2' chứ không giải quyết nó. Đây là ràng buộc kỹ thuật bắt buộc, không phải một "nice-to-have" UX.
...
* **Capability & Limit cần làm rõ:** 
  ...
  * **Ràng buộc tốc độ (theo H2'):** AI Tutor phải phản hồi trong vài giây. Học viên đã có tiền lệ bỏ AI tutor VLearn vì chậm 1–2 phút/câu để chuyển sang AI ngoài — nếu Option C không nhanh hơn rõ rệt, học viên sẽ lặp lại đúng hành vi đó và tín hiệu lại chảy ra ngoài hệ thống.
